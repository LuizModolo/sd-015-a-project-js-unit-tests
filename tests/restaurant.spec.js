...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.deepStrictEqual(obj2.fetchMenu(), { food: {}, drink: {}})
    ...
    // ```
    const obj3 = createMenu({ food: 'coxinha', drink: 'agua' });
    ...
    obj.order('coxinha');
    obj.order('sashimi');
    assert.deepStrictEqual(obj.consumption, ["coxinha", "agua", "sopa", "sashimi", "coxinha", "sashimi"]);
    ...
    assert.deepStrictEqual(obj.pay(), parseFloat((29.3 * 1.1).toFixed(2)));
  });
});
